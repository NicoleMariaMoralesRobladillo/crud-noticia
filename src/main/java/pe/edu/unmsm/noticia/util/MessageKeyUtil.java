package pe.edu.unmsm.noticia.util;
...
public final class MessageKeyUtil {
    ...
    public static final String NEW_MESSAGE_NOT_FOUND = "La noticia no se encontró.";
    public static final String BAD_REQUEST_TITLE = "Bad request";
    public static final String NEW_MESSAGE_NOT_BLANK = "El contenido de la noticia no debe ser vacío.";
